...
#ifndef MIDISTAR_INTROSCENESFMLEVENTSHANDLERCOMPONENT_H_
#define MIDISTAR_INTROSCENESFMLEVENTSHANDLERCOMPONENT_H_

#include "midistar/SfmlEventsHandlerComponent.h"

namespace midistar {

class IntroSceneSfmlEventsHandlerComponent : public SfmlEventsHandlerComponent {
 public:
